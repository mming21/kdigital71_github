...
public class EmpServiceImpl implements EmpService {
	...
	public List<EmpVO> getEmpList() {
	  ...
	  @Override public EmpVO getEmpOne(int id) { return dao.empone(id); }
	  ...
	  @Override public void deleteEmp(String name) 
	 { name = "%" + name + "%";
	  dao.deleteemp(name);
	   }
	  
	  @Override public int countEmp() { return dao.cnt(); }
	  
	  @Override public List<EmpVO> empDeptList(int[] a) 
